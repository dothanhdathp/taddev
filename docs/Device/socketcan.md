...
> Tài liệu gốc tại [SocketCAN documentation](https://www.kernel.org/doc/Documentation/networking/can.txt)
> Tài liệu này mô tả đầy đủ về SocketCAN, còn socket CAN ở đâu trong hệ thống thì mình chưa biết
> Tài liệu này dịch từ tài liệu gốc về
