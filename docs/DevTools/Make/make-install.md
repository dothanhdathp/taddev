...
Và một trong những công cụ được phổ biến nhất chính là [MSYS2](../../Tools/msys2.md), một hệ thống cho phép sử dụng môi trường giả lập như Linux trên Windows, biến đường dẫn, liên kết, ... cho phép sử dụng __Make__ trên Windows và cũng như tái sử dụng lại mã lập trình cũ, ___Makefile___, ... lôi kéo lại các lập trình viên

!!! info "Info"
    Về việc tải và cài đặt `msys2` xem tại [MSYS2](../../Tools/msys2-install.md) 
