...
<figure markdown="span">
    ![alt text](img/electric-resistor.png)
    <figcaption>Ký hiệu điện trở kiểu Mỹ.<br>(a) Điện trở thường,<br>(b) Biến trở,<br>(c) Chiết áp
</figcaption>
</figure>

<figure markdown="span">
    ![alt text](img/electric-resistor-1.png)
...
<figure markdown="span">
    ![alt text](img/electric-resistor-2.png)
