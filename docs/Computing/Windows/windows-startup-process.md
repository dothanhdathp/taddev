...
1. Mở tệp startup bằng lệnh `shell:startup` trong ___cmd___ hoặc hộp thoại ___run___. Lệnh đó sẽ mở ra một hộp thực thi tại địa chỉ:
    ```txt
    %USERPROFILE%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup
    ```
1. Đưa trực tiếp _shortcut_ của chương trình muốn chạy lúc khởi động vào đây. Từ đó về sau các chương trình ở đây sẽ được tự động khởi động.
